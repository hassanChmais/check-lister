...
<div class="col-md-8">
<div class="card">
<div class="card-header">{{ $list_name }}
</div>
<div class="card-body">
<table class="table">
...
<use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-arrow-thick-top') }}"></use></svg>

@else
<svg class="c-sidebar-nav-icon">
<use xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-arrow-thick-bottom') }}"></use></svg>
@endif
</td>
    </tr>
    @if (in_array($task->id, $opened_tasks))
