...
<li class="c-sidebar-nav-title">{{ __('Manage Checklists') }}</li>
            @foreach ($checklistGroups as $group)
                <li class="c-sidebar-nav-item c-sidebar-nav-dropdown"><a class="c-sidebar-nav-link c-sidebar-nav-dropdown-toggle" href="{{ route('admin.checklist_groups.edit', $group->id) }}">
                        <svg class="c-sidebar-nav-icon">
            ...
            <li class="mt-2 c-sidebar-nav-item c-sidebar-nav-dropdown">
             ...
             @foreach($group['checklists'] as $checklist )
                            <li class="c-sidebar-nav-item c-sidebar-nav-dropdown c-show">
                                <a class="c-sidebar-nav-link"
                                   href="{{route('user.checklist' , $checklist['id'])}}">
                                    <svg class="c-sidebar-nav-icon">
                                        <use
                                            xlink:href="{{ asset('vendors/@coreui/icons/svg/free.svg#cil-list') }}"></use>
                                    </svg>
...
'completed_task' => $checklist['completed_tasks_count'],
